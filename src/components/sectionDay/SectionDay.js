  ...
  render() {
    return (
      <section className="container-section-day">
        <Search lang={this.props.lang} error={this.props.error} />
        <Sunrise lang={this.props.lang} sunrise={this.props.sunrise} timezone={this.props.timezone} />
        <LangButton lang={this.props.lang} />
        <Sunset lang={this.props.lang} sunset={this.props.sunset} timezone={this.props.timezone} />
        <City currentCity={this.props.currentCity} />
        <Temperature tempUnits={this.props.unit} temp={this.props.temp} />
        <WeatherIcon icon={this.props.icon} />
        <WeatherDescription description={this.props.description} />
        <CurrentDate currentDate={this.props.currentDate} lang={this.props.lang} timezone={this.props.timezone} />
        <WeatherMain
